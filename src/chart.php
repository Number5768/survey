...
<div class="content-header shadow-lg border border-light">
    <div class="container-fluid animate__animated animate__bounceInDown animate__delay 2s">
        <div class="row mb-2 ">
            <div class="col-sm-6 ">
...
<div class="container-fluid">
    <div class="row " style="margin-top: 30px;">
        ...
        <div class="col-lg-3 col-xs-6 animate__animated animate__bounceInDown animate__delay 2s">
            <!-- small box -->
        ...
        <div class="container-fluid animate__animated animate__bounceInDown animate__delay 3s">
            <div class="row ">
                <div class="col-12">
                    <!-- jQuery Knob -->
                    <div class="card shadow-lg border border-light" style="margin-top: 30px;">
                        ...
                        <div class="card-body" style="padding: 0px !important;">
                            <div class="row pb-3">
                                <div class="col-md-3 pt-3 text-center animate__animated animate__bounceInDown animate__delay 4s">
