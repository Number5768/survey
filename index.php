...
<body>
    ...
    <header class="header-area header-sticky">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="logo text-center">แบบสำรวจวัดระดับความพึงพอใจ</h3>
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section">
                                <div id="login" class="log_in">LOGIN</div>
                            </li>
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <button class="btn btn-danger">55555555555555555555</button>
                    </div>
                </div>
            </div>
        </div>
...
<script src="../survey/controller/page_survey.js"></script>
